/**
 * @generated SignedSource<<e16017494a66289d89f7e8b2553ce5d8>>
 * @flow
...
export type ReposListPaginationQuery$variables = {|
  count?: ?number,
  cursor?: ?string,
  id: string,
|};
export type ReposListPaginationQueryVariables = ReposListPaginationQuery$variables;
export type ReposListPaginationQuery$data = {|
  +node: ?{|
    +$fragmentSpreads: RepoPaginationReposListComponent_user$fragmentType,
  |},
|};
export type ReposListPaginationQueryResponse = ReposListPaginationQuery$data;
export type ReposListPaginationQuery = {|
  variables: ReposListPaginationQueryVariables,
  response: ReposListPaginationQuery$data,
|};
*/
...
return {
  ...
  "params": {
    "cacheID": "7bf107f55ab15fed1f4fe17526536c59",
    "id": null,
    "metadata": {},
    "name": "ReposListPaginationQuery",
    "operationKind": "query",
